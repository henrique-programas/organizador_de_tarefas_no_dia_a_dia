...
<div class="card">
  ...
  <form action="{{ route('register') }}" method="post">
    @csrf
    <div class="row-2">
      <div class="field" style="animation-delay:.25s; margin-bottom:16px">
        <label for="nome">Nome</label>
        <div class="input-wrap">
          <input type="text" name="name" id="nome" placeholder="João" autocomplete="given-name" require/>
          <span class="icon">
    ...
    <div class="field" style="animation-delay:.33s">
      ...
      <div class="input-wrap">
        <input type="email" name="email" id="email" placeholder="seuemail@exemplo.com" autocomplete="email" require/>
        <span class="icon">
    ...
    <div class="field" style="animation-delay:.37s">
      ...
      <div class="input-wrap">
        <input type="password" name="password" id="senha" placeholder="Mín. 8 caracteres" autocomplete="new-password" oninput="checkStrength(this.value)" require/>
        <span class="icon">
    ...
    <div class="field" style="animation-delay:.41s">
      ...
      <div class="input-wrap">
        <input type="password" name="password_confirmation" id="confirma" placeholder="Repita a senha" autocomplete="new-password" require/>
        <span class="icon">
